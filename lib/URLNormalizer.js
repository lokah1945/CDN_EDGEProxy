...
/**
 * CDN EdgeProxy v6.0.0 — URLNormalizer
 *
 * No bug fixes required in this module.
 * Preserved exactly from v5 — all URL normalization, alias key generation,
 * tracking param stripping, and vary-key logic unchanged.
 */
